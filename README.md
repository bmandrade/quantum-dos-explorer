...
- **Direct compute-on-change**: each slider recomputes immediately in
  its callback; the caching above keeps that cheap for temperature and
  density, and the truncated broadening keeps geometry recomputes fast.
